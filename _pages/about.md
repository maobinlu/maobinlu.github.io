...
We propose the Kinematics-Aware Transformer (KAT) policy to enhance spatial awareness and interaction learning in robot imitation learning. Conventional methods typically rely on late fusion of visual observations and robot states, without explicitly establishing spatial correspondence between the robot kinematic space and the visual observation space. To address this limitation, the KAT policy introduces kinematics-guided spatial and interaction information at multiple levels of visual processing. Specifically, Kinematics-Guided Spatial Anchoring (KGSA) introduces explicit end-effector cues at the visual input, Kinematics-Guided Position Encoding (KGPE) incorporates relative spatial relationships into intermediate visual features, and Kinematics-Guided Interaction Tokenization (KGIT) aggregates interaction-relevant multi-view visual context around the projected end-effector.

**Video**: <a href="https://www.bilibili.com/video/BV1FWb96tEbn/?spm_id_from=333.337.search-card.all.click&vd_source=a820699b51d8984ffecfd281dbc63dc6" class="gold-link">bilibili<img src="images/bilibili.png" alt="icon" class="icon"></a>/<a href="https://github.com/maobinlu/demos-codes/raw/refs/heads/main/demo-movies/KAT_video_pro.mp4" class="gold-link-track" data-link-id="link14">Download<img src="images/download-icon.svg" alt="icon" class="icon"></a>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;<span id="count-link14"><b>Download Count: </b></span>
...
**Video**: <a href="https://www.bilibili.com/video/BV1AgF4zhE7C/?spm_id_from=333.1387.homepage.video_card.click" class="gold-link">bilibili<img src="images/bilibili.png" alt="icon" class="icon"></a>&nbsp;&nbsp;**Code**: <a href="https://github.com/maobinlu/demos-codes/tree/main/codes/1.Precise%20Robot%20Dual-Arm%20Manipulation%20A%20Monocular%20RGB-%20Camera-Based%20Teleoperation%20System" class="gold-link">Github<img src="images/github-mark.png" alt="icon" class="icon"></a>/<a href="https://github.com/maobinlu/demos-codes/releases/download/v1.0/1.Precise.Robot.Dual-Arm.Manipulation.A.Monocular.RGB-.Camera-Based.Teleoperation.System.zip" class="gold-link-track" data-link-id="link10">Download<img src="images/download-icon.svg" alt="icon" class="icon"></a>&nbsp;&nbsp;
<span id="count-link10"><b>Download Count: </b></span>
...
**Videos**: <a href="https://www.bilibili.com/video/BV1wVF4zbEhS/?spm_id_from=333.1387.homepage.video_card.click" class="gold-link">bilibili<img src="images/bilibili.png" alt="icon" class="icon"></a>&nbsp;&nbsp;**Code**: <a href="https://github.com/maobinlu/demos-codes/tree/main/codes/2.Experiment%20for%20mobile%20robot%20connectivity%20control%20game" class="gold-link">Github<img src="images/github-mark.png" alt="icon" class="icon"></a>/<a href="https://github.com/maobinlu/demos-codes/releases/download/v1.0/2.Mobile_robots_experiment_for_a_connectivity_control_game.zip" class="gold-link-track" data-link-id="link1">Download<img src="images/download-icon.svg" alt="icon" class="icon"></a>&nbsp;&nbsp;
...
**Videos**: <a href="https://www.bilibili.com/video/BV1AGF4zFEgt/?spm_id_from=333.1387.homepage.video_card.click" class="gold-link">bilibili<img src="images/bilibili.png" alt="icon" class="icon"></a>&nbsp;&nbsp;**Code**: <a href="https://github.com/maobinlu/demos-codes/tree/main/codes/3.Output%20Feedback%20Control%20of%20Uncertain%20Euler%E2%80%93Lagrange%20Systems%20by%20Internal%20Model" class="gold-link">Github<img src="images/github-mark.png" alt="icon" class="icon"></a>/<a href="https://github.com/maobinlu/demos-codes/releases/download/v1.0/3.Output.Feedback.Control.of.Uncertain.Euler.Lagrange.Systems.by.Internal.Model.zip" class="gold-link-track" data-link-id="link2">Download<img src="images/download-icon.svg" alt="icon" class="icon"></a>&nbsp;&nbsp;
...
**Videos**: <a href="https://www.bilibili.com/video/BV1pGF4zFE2F/?spm_id_from=333.1387.homepage.video_card.click" class="gold-link">bilibili<img src="images/bilibili.png" alt="icon" class="icon"></a>&nbsp;&nbsp;**Code**: <a href="https://github.com/maobinlu/demos-codes/tree/main/codes/4.ius_uav-master" class="gold-link">Github<img src="images/github-mark.png" alt="icon" class="icon"></a>/<a href="https://github.com/maobinlu/demos-codes/releases/download/v1.0/4.2024.-.zip" class="gold-link-track" data-link-id="link3">Download<img src="images/download-icon.svg" alt="icon" class="icon"></a>&nbsp;&nbsp;
...
**Videos**: <a href="https://www.bilibili.com/video/BV1TPF4zvEPh/?spm_id_from=333.1387.homepage.video_card.click" class="gold-link">bilibili<img src="images/bilibili.png" alt="icon" class="icon"></a>&nbsp;&nbsp;**Code**: <a href="https://github.com/maobinlu/demos-codes/tree/main/codes/5.nmpc_traj-master" class="gold-link">Github<img src="images/github-mark.png" alt="icon" class="icon"></a>/<a href="https://github.com/maobinlu/demos-codes/releases/download/v1.0/5.2024.-.zip" class="gold-link-track" data-link-id="link4">Download<img src="images/download-icon.svg" alt="icon" class="icon"></a>&nbsp;&nbsp;
...
**Videos**: <a href="https://www.bilibili.com/video/BV1KPF4zvEjV/?spm_id_from=333.1387.homepage.video_card.click" class="gold-link">bilibili<img src="images/bilibili.png" alt="icon" class="icon"></a>&nbsp;&nbsp;**Code**: <a href="https://github.com/maobinlu/demos-codes/tree/main/codes/6.robot_arm_gripper-master" class="gold-link">Github<img src="images/github-mark.png" alt="icon" class="icon"></a>/<a href="https://github.com/maobinlu/demos-codes/releases/download/v1.0/6.2023.Challenge.Cup.Capital.University.Students.Extracurricular.Academic.and.Scientific.Works.Provincial.Competition.Champion.zip" class="gold-link-track" data-link-id="link5">Download<img src="images/download-icon.svg" alt="icon" class="icon"></a>&nbsp;&nbsp;
...
**Videos**: <a href="https://www.bilibili.com/video/BV14PF4zvEnD/?spm_id_from=333.1387.homepage.video_card.click" class="gold-link">bilibili<img src="images/bilibili.png" alt="icon" class="icon"></a>&nbsp;&nbsp;**Code**: <a href="https://github.com/DareScanMyCode/CDC_Competition" class="gold-link">Github<img src="images/github-mark.png" alt="icon" class="icon"></a>/<a href="https://github.com/maobinlu/demos-codes/releases/download/v1.0/7.IROS.2024.Cooperative.Aerial.Robots.Inspection.Challenge.zip" class="gold-link-track" data-link-id="link8">Download<img src="images/download-icon.svg" alt="icon" class="icon"></a>&nbsp;&nbsp;
...
**Code**: <a href="https://github.com/DareScanMyCode/ws_comp29" class="gold-link-track" data-link-id="link9">Github<img src="images/github-mark.png" alt="icon" class="icon"></a>/<a href="https://github.com/maobinlu/demos-codes/releases/download/v1.0/8.Research.Challenge.on.Swarm-Based.Micro.UAV.Search.in.Denied.Environments.zip" class="gold-link-track" data-link-id="link9">Download<img src="images/download-icon.svg" alt="icon" class="icon"></a>&nbsp;&nbsp;<!-- **Design**: <a href="https://github.com/DareScanMyCode/CDC_Competition" class="gold-link-track" data-link-id="link9">Github<img src="images/github-mark.png" alt="icon" class="icon"></a>-->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
Authors: J. Guan, Y. Wang, Y. Wang, F. Zhou, C. Wang, Y. Lin, Y. Kang, H. Zhang, W. Li, X. Chen; Y. Jiang Y. Zhuang, S. Li, G. Ji

**Codes**: <a href="https://github.com/maobinlu/demos-codes/releases/download/v1.0/9.SRGS.zip" class="gold-link-track" data-link-id="link11">SRGS</a>/<a href="https://github.com/maobinlu/demos-codes/releases/download/v1.0/10.SFINN.zip" class="gold-link-track" data-link-id="link11">SFINN</a>/<a href="https://github.com/maobinlu/demos-codes/releases/download/v1.0/11.DSSC.zip" class="gold-link-track" data-link-id="link11">DSSC</a>/<a href="https://github.com/maobinlu/demos-codes/releases/download/v1.0/12.scINRB.zip" class="gold-link-track" data-link-id="link11">scINRB</a>/<a href="https://github.com/maobinlu/demos-codes/releases/download/v1.0/13.scTsI.zip" class="gold-link-track" data-link-id="link11">scTsI</a>/<a href="https://github.com/maobinlu/demos-codes/releases/download/v1.0/14.MISF.zip" class="gold-link-track" data-link-id="link11">MISF</a><!-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
...
**Codes**: <a href="https://github.com/maobinlu/demos-codes/releases/download/v1.0/15.MDPPlanner.zip" class="gold-link-track" data-link-id="link12">MDP</a>/<a href="https://github.com/maobinlu/demos-codes/releases/download/v1.0/16.DroneIndoorROS2.zip" class="gold-link-track" data-link-id="link12">DroneIndoor</a>/<a href="https://github.com/maobinlu/demos-codes/releases/download/v1.0/17.Enforcement_IWA.zip" class="gold-link-track" data-link-id="link12">EnforcementIWA</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
